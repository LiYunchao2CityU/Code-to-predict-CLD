...
if __name__ == '__main__':
    ...
    for i in range(number):
        ...
        regression = RandomForestRegressor(n_estimators=20,criterion='squared_error',max_features='auto',min_samples_split=2,
                                  min_samples_leaf=1,max_leaf_nodes=None,min_weight_fraction_leaf=0.0,random_state=32).fit(x_train_new,y_train_new)
    ...
    excelFilePath = "D:/pythonproject/ThesisModel/GA-RFM/result/RBFResultData.xlsx"
